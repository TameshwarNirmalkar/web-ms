...
export class AuthenticationComponent implements OnInit {
  ...
  public imageName = 'iPhone'; //This is hardcoded to made make overlay in center
        ...
        if (!isErrorInResponse) {
          ...
          if (validateSession) {
            if (response.data.enable_otp) {
              ...
              // ************ Just change flag value for displaying banner after login *****************//
              this.authService.setEventCelebrateFlag(false);
              // ***************************************************************************************//
  ...
  viewAppInfoOverlay(imageFor) {
    this.imageName = imageFor;
