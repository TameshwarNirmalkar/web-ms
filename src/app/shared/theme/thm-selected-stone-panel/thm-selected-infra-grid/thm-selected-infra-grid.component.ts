...
import { ThmInfraGridComponent } from '../../thm-infra-grid/thm-infra-grid.component';

declare var $: any;

@Component({
  selector: 'thm-selected-grid',
  templateUrl: './thm-selected-grid.component.html',
  styleUrls: ['./thm-selected-grid.component.scss']
})

export class ThmSelectedGridComponent extends ThmInfraGridComponent implements OnInit, OnChanges {

  ngOnInit () {

    super.ngOnInit();
    // this.calculatedGridHeight = ( $('#grid' + this.gridName.replace('selectedStoneGrid', '')).igGrid('option', 'height') - 5);
    // this.calculatedGridHeight = 300;
  }
