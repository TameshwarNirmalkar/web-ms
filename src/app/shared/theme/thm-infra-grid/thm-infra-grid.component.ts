...
@Component({
  selector: 'thm-infra-grid',
  templateUrl: './thm-infra-grid.component.html',
  styleUrls: ['./thm-infra-grid.component.scss']
})

export class ThmInfraGridComponent implements OnInit, OnDestroy, OnChanges, AfterViewInit {
